            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class = <?= urlsIs("/") ? "bg-gray-900 text-white" : "bg-gray-300"?> aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Home</a>
                        <a href="/about" class= <?= urlsIs("/about.php") ? "bg-gray-900 text-white" : "bg-gray-300"?> "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/notes" class= <?= urlsIs("/index.php") ? "bg-gray-900 text-white" : "bg-gray-300"?> "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                        <a href="/contact" class= <?= urlsIs("/contact.php") ? "bg-gray-900 text-white" : "bg-gray-300"?> "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        <button class="text-white relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                            ...
                            <?php else : ?>
                                <a href="/register" class= <?= urlsIs("/register.php") ? "bg-gray-900 text-white" : "bg-gray-300"?> "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Register</a>
                                <a href="/login" class= <?= urlsIs("/login.php") ? "bg-gray-900 text-white" : "bg-gray-300"?> "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Log In</a>
                            <?php endif; ?>
